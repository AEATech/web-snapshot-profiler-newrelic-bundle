...
use AEATech\WebSnapshotProfilerNewrelicBundle\AEATechWebSnapshotProfilerNewrelicBundle;
...
class AEATechWebSnapshotProfilerNewrelicBundleTest extends KernelTestCase
{
    /**
     * {@inheritDoc}
     */
    ...
    protected static function createKernel(array $options = []): KernelInterface
    {
        ...
        $kernel->addTestBundle(AEATechWebSnapshotProfilerNewrelicBundle::class);
    ...
    public static function getRouteToRandProbabilityDataProvider(): array
    {
        return [
            ...
            '100% - probability' => [
                'routeToProbability' => [
                    [
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_ROUTE_NAME => 'route',
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_PROBABILITY => 100,
                    ],
                ],
                'expected' => [
                    'route' => 1,
            ...
            '1% - probability' => [
                'routeToProbability' => [
                    [
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_ROUTE_NAME => 'route',
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_PROBABILITY => 1,
                    ],
                ],
                'expected' => [
                    'route' => 100,
            ...
            '50% - probability' => [
                'routeToProbability' => [
                    [
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_ROUTE_NAME => 'route',
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_PROBABILITY => 50,
                    ],
                ],
                'expected' => [
                    'route' => 2,
            ...
            '33% - probability' => [
                'routeToProbability' => [
                    [
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_ROUTE_NAME => 'route',
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_PROBABILITY => 33,
                    ],
                ],
                'expected' => [
                    'route' => 4,
            ...
            '66% - probability' => [
                'routeToProbability' => [
                    [
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_ROUTE_NAME => 'route',
                        AEATechWebSnapshotProfilerNewrelicBundle::CONFIG_KEY_PROBABILITY => 66,
                    ],
                ],
                'expected' => [
                    'route' => 2,
    ...
    {
        $actual = AEATechWebSnapshotProfilerNewrelicBundle::getRouteToRandProbability($routeToProbability);
    ...
    private function getActualEventMatchers(ContainerInterface $container): array
    {
        ...
        $eventMatcher = $container->get('aea_tech_web_snapshot_profiler_newrelic.event_matcher');

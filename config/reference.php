 ...
 *     },
 * }
 * @psalm-type AeaTechWebSnapshotProfilerNewrelicConfig = array{
 *     is_profiling_enabled: bool, // Is profiling enabled
 *     newrelic: array{
 *         app_name: scalar|null, // Newrelic app name
 *         license: scalar|null, // Newrelic license
 *     },
 *     event_matcher: array{
 *         is_profile_all_routes: bool, // Is profiling all routes enabled
 *         header: array{
 *             is_enabled: bool, // Is profiling by header enabled
 *             name: scalar|null, // Header name to execute profiling
 *             value: scalar|null, // Header value to execute profiling
 *         },
 *         request: array{
 *             is_enabled: bool, // Is profiling by request enabled
 *             name: scalar|null, // Request param to execute profiling
 *             route_to_probability: list<array{ // Default: []
 *                 route_name: scalar|null, // Route name to execute profiling
 *                 probability: int, // Probability to execute profiling (1 - 1% of requests, 100 - 100% of requests)
 *             }>,
 *         },
 *         route: array{
 *             is_enabled: bool, // Is profiling by route enabled
 *             route_to_probability: list<array{ // Default: []
 *                 route_name: scalar|null, // Route name to execute profiling
 *                 probability: int, // Probability to execute profiling (1 - 1% of requests, 100 - 100% of requests)
 *             }>,
 ...
 *     aea_tech_web_snapshot_profiler_newrelic?: AeaTechWebSnapshotProfilerNewrelicConfig,
 *     "when@test"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
